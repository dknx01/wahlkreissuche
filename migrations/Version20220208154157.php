...
final class Version20220208154157 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'add sate column for wahlkreis';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE wahlkreis ADD state VARCHAR(255) NOT NULL');
    }
